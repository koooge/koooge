...
- [koooge/leetcode](https://github.com/koooge/leetcode) - https://leetcode.com (3 days ago)
...
- [typescript-eslint/typescript-eslint](https://github.com/typescript-eslint/typescript-eslint) ([v5.12.1](https://github.com/typescript-eslint/typescript-eslint/releases/tag/v5.12.1), 3 days ago) - :sparkles: Monorepo for all the tooling which enables ESLint to support TypeScript
...
- [DioxusLabs/dioxus](https://github.com/DioxusLabs/dioxus) - Elegant React-like library for building user interfaces for desktop, web, mobile, SSR, liveview, and more. (1 day ago)
- [GoogleChromeLabs/serial-terminal](https://github.com/GoogleChromeLabs/serial-terminal) - Demo application for the Serial API. (2 days ago)
- [WICG/serial](https://github.com/WICG/serial) - Serial ports API for the platform.  (5 days ago)
- [WICG/webhid](https://github.com/WICG/webhid) - Web API for accessing Human Interface Devices (HID) (5 days ago)
- [WICG/webusb](https://github.com/WICG/webusb) - Connecting hardware to the web. (5 days ago)
