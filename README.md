...
- [typescript-eslint/typescript-eslint](https://github.com/typescript-eslint/typescript-eslint) ([v5.16.0](https://github.com/typescript-eslint/typescript-eslint/releases/tag/v5.16.0), 6 days ago) - :sparkles: Monorepo for all the tooling which enables ESLint to support TypeScript
