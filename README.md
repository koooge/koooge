...
- [typescript-eslint/typescript-eslint](https://github.com/typescript-eslint/typescript-eslint) ([v5.14.0](https://github.com/typescript-eslint/typescript-eslint/releases/tag/v5.14.0), 6 days ago) - :sparkles: Monorepo for all the tooling which enables ESLint to support TypeScript
...
- [JPCERTCC/EmoCheck](https://github.com/JPCERTCC/EmoCheck) - Emotet detection tool for Windows OS (4 days ago)
- [emscripten-core/emsdk](https://github.com/emscripten-core/emsdk) - Emscripten SDK (5 days ago)
