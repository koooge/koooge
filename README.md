...
- [typescript-eslint/typescript-eslint](https://github.com/typescript-eslint/typescript-eslint) ([v5.12.0](https://github.com/typescript-eslint/typescript-eslint/releases/tag/v5.12.0), 1 week ago) - :sparkles: Monorepo for all the tooling which enables ESLint to support TypeScript
...
- [WICG/serial](https://github.com/WICG/serial) - Serial ports API for the platform.  (2 days ago)
- [WICG/webhid](https://github.com/WICG/webhid) - Web API for accessing Human Interface Devices (HID) (2 days ago)
- [WICG/webusb](https://github.com/WICG/webusb) - Connecting hardware to the web. (2 days ago)
- [kewisch/gdata-provider](https://github.com/kewisch/gdata-provider) - Provider for Google Calendar (4 days ago)
