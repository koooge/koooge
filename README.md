...
- [typescript-eslint/typescript-eslint](https://github.com/typescript-eslint/typescript-eslint) ([v5.12.1](https://github.com/typescript-eslint/typescript-eslint/releases/tag/v5.12.1), 1 week ago) - :sparkles: Monorepo for all the tooling which enables ESLint to support TypeScript
...
- [DioxusLabs/dioxus](https://github.com/DioxusLabs/dioxus) - Elegant React-like library for building user interfaces for desktop, web, mobile, SSR, liveview, and more. (5 days ago)
- [GoogleChromeLabs/serial-terminal](https://github.com/GoogleChromeLabs/serial-terminal) - Demo application for the Serial API. (6 days ago)
