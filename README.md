...
- [Ignore missing containers when compose down --remove-orphans](https://github.com/docker/compose/pull/11692) on [docker/compose](https://github.com/docker/compose) (1 day ago)
