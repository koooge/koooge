...
- [typescript-eslint/typescript-eslint](https://github.com/typescript-eslint/typescript-eslint) ([v5.10.1](https://github.com/typescript-eslint/typescript-eslint/releases/tag/v5.10.1), 2 days ago) - :sparkles: Monorepo for all the tooling which enables ESLint to support TypeScript
- [hashicorp/terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ([v3.73.0](https://github.com/hashicorp/terraform-provider-aws/releases/tag/v3.73.0), 5 days ago) - Terraform AWS provider
...
- [OpenSC/OpenSC](https://github.com/OpenSC/OpenSC) - Open source smart card tools and middleware. PKCS#11/MiniDriver/Tokend (3 days ago)
...
- [fido-alliance/webauthn-demo](https://github.com/fido-alliance/webauthn-demo) - WebAuthn Workshop Demo [Completed DEMO is at completed demo-branch] (3 days ago)
- [webauthn-open-source/fido2-lib](https://github.com/webauthn-open-source/fido2-lib) - A node.js library for performing FIDO 2.0 / WebAuthn server functionality (3 days ago)
